...
export class AIChatPanel {
  ...
  // ─── 位置记忆 ───
  private static readonly POS_KEY = 'fleur-epub-ai-panel-pos';
  private static getSavedPos(plugin: FleurEpubPlugin): { left: number; top: number } | null {
    try {
  ...
  private static savePos(plugin: FleurEpubPlugin, left: number, top: number) {
    try {
